...
class AlphaBetaStrategyTest {
    ...
    private AlphaBetaMoveStrategy alphaBetaStrategy;
    private CSudokuBoard board;
    private AIPlayer aiPlayer;

    @BeforeEach
    void setUp() {
        alphaBetaStrategy = new AlphaBetaMoveStrategy();
        ...
        aiPlayer = new AIPlayer(alphaBetaStrategy);
    ...
    void testSelectMoveBestMove() {
        // Mock the AlphaBeta evaluation process (not using the mocked objects anymore)
        ...
        Move bestMove = alphaBetaStrategy.selectMove(board, aiPlayer);
    ...
    @Test
    void testAlphaBetaWithDepthZero() {
        // For simplicity, let's mock the evaluation result to return 10 for this test.
        int result = alphaBetaStrategy.alphaBeta(
            new EvaluatedSimulatedBoard(board, aiPlayer), 
            0,                          // depth
    ...
    void testGetValidMoves() {
        ...
        List<Move> validMoves = alphaBetaStrategy.getValidMoves(new EvaluatedSimulatedBoard(board, aiPlayer), aiPlayer);
    ...
    @Test
    void testAlphaBetaNodeCounting() {
