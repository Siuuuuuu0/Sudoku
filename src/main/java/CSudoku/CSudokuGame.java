...
import CSudoku.player.ai.MCTSStrategy;
...
public class CSudokuGame {
    ...
    public void play() {
        ...
        System.out.println("============================");
        System.out.println("Temps total de réflexion Joueur 1 : " + (double) time1 / 1000.0 + " seconds");
        System.out.println("Temps total de réflexion Joueur 2 : " + (double) time2 / 1000.0 + " seconds");
        System.out.println("============================");
    }
